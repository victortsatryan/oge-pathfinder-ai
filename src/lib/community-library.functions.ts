...
/**
 * Общая библиотека: опубликованные материалы в рамках релизной программы.
 * Доступна и ученику, и преподавателю (одна и та же база).
 */
export const listPublicLibrary = createServerFn({ method: "POST" })
  .middleware([requireSupabaseAuth])
