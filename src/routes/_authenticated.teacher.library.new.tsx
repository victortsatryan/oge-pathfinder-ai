...
export const Route = createFileRoute("/_authenticated/teacher/library/new")({
    ...
    <>
      ...
      <div className="pf-block mt-6 space-y-6 max-w-3xl">
        ...
        <div className="flex flex-wrap gap-3 pt-2">
          ...
          <Button variant="ghost" onClick={() => navigate({ to: "/teacher/library" })}>
            Отмена
          </Button>
        </div>
      </div>
